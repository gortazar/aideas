...
// sandbox with no node_modules and no network. Kept deliberately close to
// ideas/gnome-tasks/eslint.config.mjs — same desktop, same house style.
