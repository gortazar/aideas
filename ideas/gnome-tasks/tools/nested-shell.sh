...
#
# This is the instrument behind docs/gnome-internals.md and the smoke tests: a real compositor
...
#
#   source /tmp/gnome-tasks-nested/env
...
export GNOME_TASKS_NESTED_STATE=$STATE
EOF
