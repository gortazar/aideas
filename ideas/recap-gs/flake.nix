{
  description = "recap-gs — agent statuses in the GNOME Shell top bar (dev/test/release env)";
      ...
      in {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "  ./scripts/install.sh  install into ~/.local/share/gnome-shell/extensions"
          '';
        };
