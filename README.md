...
26. [restore-wss](ideas/restore-wss) - One open BLOCKER on `gortazar_restore-wss` is neither fixed nor documented while `STATUS.md` says `status: done`. Minor update. It is (finished 2026-09-15, v0.3)
